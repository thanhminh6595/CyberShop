...
import hotSaleImg from "../../assets/21. AirPods_Pro_2nd 3.svg";
...
const AccessoryHotSale = (props) => {
  const {
    categoryHot: accessoryHotSaleItem,
...
export default AccessoryHotSale;
