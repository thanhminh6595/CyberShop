...
import hotSaleImg from "../../assets/16. Macbook-Air-M2-star-1 3.svg";
...
const MacbookHotSale = (props) => {
  const { categoryHot: macbookHotSaleItem } = useRenderCard(
    DUMMY_HOTSALE,
    ProductCard
  );
    ...
    <Card>
      <div className="my-10 bg-white rounded-xl">
        <div className="px-3 py-10">
          ...
          <div className="overflow-scroll max-md:h-490px">
